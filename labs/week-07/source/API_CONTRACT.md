...
| **ผู้จัดทำ** | `นายศักดิ์ณรงค์ นำนนท์ 68543210069-9` |
...
**ทำอะไร** `ทำการเปลี่ยนสถานะคำร้องเป็น completed แล้วgetหาคำร้องขอที่ไม่มี`
...
```json
{
    "error": "ไม่พบคำร้องรหัส REQ-1111"
}
```
...
|---|---|---|:---:|
| 1.0.0 | `<22/09/2026>` | เวอร์ชันแรก — GET, POST, DELETE | — |
| 2.0.0 | `<23/09/2026>` | เพิ่ม `PUT /api/requests/001`,`DELETE /api/requests/001` และ CORS | ไม่ |
